...
# Using line style encoding for continent
sns.lineplot(x='year', y='lifeExp', style='continent', dashes=True, data=data_time_range, ci=None)

plt.plot(ireland_data_time['year'], ireland_data_time['lifeExp'], color='red', linewidth=3, label='Ireland')

plt.title('Life Expectancy Over Time (1957-2007) - Continent Encoded by Line Type', fontsize=16)
